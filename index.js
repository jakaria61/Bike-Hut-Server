...
const uri = "mongodb+srv://bikehutt:QTXFbZ7xmo3ZX3B9@cluster0.nf3pc.mongodb.net/bikehut?retryWrites=true&w=majority";
const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });

// const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.x8ahu.mongodb.net/bikehut?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        const database = client.db('bikehut');
